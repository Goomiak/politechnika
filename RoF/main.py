...
title_label = tk.Label(
    start_window, 
    text="Dydaktyczna interaktywna aplikacja wizualizująca podstawy technik i systemów radiowo-fotonicznych",
...
info_label = tk.Label(
    start_window, 
    text=(
        "Aplikacja została wykonana w ramach projektu z przedmiotu Techniki i Systemy Radiowo-Fotoniczne "
    ), 
