...
def show_direct_detection(menu_window, final_button):
    slides = [
        ...
        ("simulation", "direct_sim_1", "Detekcja bezpośrednia", "Interaktywna symulacja detekcji bezpośredniejdddddddd"),
...
def show_coherent_detection(menu_window, final_button):
    slides = [
        ("image_text", "subcoherent1.png", "ddd", "Detekcja bezpośrednia jest idealna dla prostych systemów o krótkim zasięgu, natomiast detekcja koherentna znajduje zastosowanie tam, gdzie wymagana jest wysoka czułość i zaawansowana modulacja. Detekcja subkoherentna stanowi kompromis dla systemów o średnich wymaganiach, oferując pewne możliwości modulacyjne przy niższych wymaganiach sprzętowych niż pełna detekcja koherentna."),
        ("simulation", "Detekcja koherentna", "Detekcja koherentna", "Interaktywna symulacja detekcji bezpośredniejdddddddd"),
...
def show_summary(menu_window, final_button):
    slides = [
        ...
        ("simulation", "Detekcja subkoherentna", "Detekcja subkoherentna", "Interaktywna symulacja detekcji bezpośredniejdddddddd"),
        ("simulation", "Detekcja Koherentna", "Interaktywna symulacja detekcji koherentnejdddd")
    ]
